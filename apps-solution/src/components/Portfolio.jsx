      ...
      <div className="flex items-center justify-center md:py-8 flex-wrap py-4">
        {categories.map((category, index) => (
          <button
            ...
            className={`${
              index === 0
                ? "text-gray-100 border border-white hover:border-gray-200 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-white focus:ring-4 focus:outline-none focus:ring-gray-300"
              ...
              index > 0 ? "dark:text-blue-700 dark:focus:ring-gray-800" : ""
            }`}
          >
            {category}
          </button>
